                    ...
                    "<td>"+                             
                        '<ul class="list-inline m-0">'+
                            '<li class="list-inline-item">'+
                              '<button class="" data-toggle="modal" data-target="#modalExameRemarcar"  type="button" data-toggle="tooltip" data-placement="top" title="Remarcar"  onclick="chamarModalConsultaRemarcar('+paciente[consulta].id_consulta+ '), MedicosParaSelecionar() ; ">'+
                              '<i class="fa fa-edit"></i></button>'+
                            '</li>'+
                            
                            '<li class="list-inline-item">'+
                              '<button class="" data-toggle="modal" data-target="#modalExameDelete"  type="button" data-toggle="tooltip" data-placement="top" title="Desmarcar" onclick="chamarModalConsultaDelete('+paciente[consulta].id_consulta+ '); ">'+
    ...
    for (var i in exames){
        ...
        lin =   "<tr id= 'tr_Exame" +  exames[i].id_exame+"' >" + 
                    ...
                    "<td>"+                             
                        '<ul class="list-inline m-0">'+
                            '<li class="list-inline-item">'+
                              '<button class="" data-toggle="modal" data-target="#modalExameRemarcar"  type="button" data-toggle="tooltip" data-placement="top" title="Remarcar"  onclick="chamarModalExameRemarcar('+exames[i].id_exame+ '), MedicosParaSelecionar() ; ">'+
                              '<i class="fa fa-edit"></i></button>'+
                            '</li>'+
                            
                            '<li class="list-inline-item">'+
                              '<button class="" data-toggle="modal" data-target="#modalConsultaDelete"  type="button" data-toggle="tooltip" data-placement="top" title="Desmarcar" onclick="chamarModalExameDelete('+exames[i].id_exame+ '); ">'+
                              '<i class="fa fa-trash"></i></button>'+
                            '</li>'+
